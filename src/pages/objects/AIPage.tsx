...
import type {AiSearchRequest} from "../../entities/ai/ai.request.types";
import type {  AiSearchResponse} from "../../entities/ai/ai.response.types";
import type { AiItem} from "../../entities/ai/ai.item.types";
